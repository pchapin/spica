...
import edu.vtc.spica.GraphAlgorithms;
import edu.vtc.spica.SimpleGraph;

/**
 * This class demonstrates some of the graph algorithms in GraphAlgorithms.
 */
public class GraphDemo {
    ...
    public static void main(String[] argv)
    {
        ...
        try {
            ...
            // Let the user ask about many destination verticies.
            while (true) {
